...
in a sense, dCENTERLAND island can be conceptualized as an island of safety deposit boxes. 1 DECNTRL token represents 1 exchangable dCENTRALAND citizenship (aka membership) representing one virtual safety deposit box, one vote in the dCENTERLAND DAO FOREVER.
